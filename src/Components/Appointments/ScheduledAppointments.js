...
function ScheduledAppointments() {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          "http://localhost:3000/api/v1/admin/ScheduledAppointments",
        ...
        setScheduledAppointment(response.data.allAppointments);
  ...
  return (
    <div className="main" style={{ height: "100%" }}>
      <h3 style={{ display: "flex" }}>Scheduled Appointments</h3>
      {scheduledappointment.map((appointment) => (
        <div
          style={{
